...
* **Pseudocódigo**
* **Teste de uso**
* **Tipos de dados: Definição, importância e exemplos**
* **Estruturas de Decisão**
* **Estruturas de Repetição**
* **Listas e Arrays**
* **Funções**
* **Exercício em Pseudocódigo**
* **Discussão sobre desempenho e como criar algoritmos**
* **Video Aulas:**
  - [Aula 1 - Apresentando Algoritmos](https://youtu.be/SFxqcQesypA)
  - [Aula 2 - Fluxos Simples, Sequencial](https://youtu.be/GBDP6yfwdfY)
  - [Aula 3 - Tipos de Dados](https://youtu.be/gK2CQzcRoMk)
  - [Aula 4 - Decisão](https://youtu.be/_JHAdHycVys)
  - [Aula 5 - Repetição](https://youtu.be/eS8RTUW82GA)
  - [Aula 6 - Listas/Arrays](https://youtu.be/jS2kLorLmko)
  - [Aula 7 - Funções](https://youtu.be/X8mdslSxvqQ)
  - [Aula 8 - Exercício Completo (Pseudocódigo)](https://youtu.be/tlJ-7u14skQ)
...
* **Casting:** Conversão entre tipos de dados.
  * Possibilidades: Abaixo estão relacionados todos os casos possível na linguagem Java, mostrando a conversão de um valor para outro. A indicação __Impl.__ quer dizer que aquel cast é implícito e automático, ou seja, não precisa indicar o cast explicitamente (lembrando que o tipo boolean não pode ser convertido para nenhum outro tipo).
